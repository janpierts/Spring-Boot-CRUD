...
public interface Crud_RepositoryPort {
    ...
    Crud_Entity update_Crud_Entity(String typeBean,InsertUpdate_Crud_Model entity);
    Crud_Entity update_Crud_Entity_JDBC_SP(String typeBean,InsertUpdate_Crud_Model entity);
    Crud_Entity update_Crud_Entity_JPA_SP(String typeBean,InsertUpdate_Crud_Model entity);
